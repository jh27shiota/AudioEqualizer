...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.EQ.autotvin_in_stream_V_data_V.dat"
         "c.EQ.autotvin_in_stream_V_keep_V.dat"
         "c.EQ.autotvin_in_stream_V_strb_V.dat"
         "c.EQ.autotvin_in_stream_V_user_V.dat"
         "c.EQ.autotvin_in_stream_V_last_V.dat"
         "c.EQ.autotvin_in_stream_V_id_V.dat"
         "c.EQ.autotvin_in_stream_V_dest_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.EQ.autotvout_out_stream_V_data_V.dat"
         "rtl.EQ.autotvout_out_stream_V_keep_V.dat"
         "rtl.EQ.autotvout_out_stream_V_strb_V.dat"
         "rtl.EQ.autotvout_out_stream_V_user_V.dat"
         "rtl.EQ.autotvout_out_stream_V_last_V.dat"
         "rtl.EQ.autotvout_out_stream_V_id_V.dat"
         "rtl.EQ.autotvout_out_stream_V_dest_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
