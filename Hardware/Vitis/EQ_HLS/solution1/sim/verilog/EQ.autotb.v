...
`define AESL_DEPTH_sample_rate 1
...
`define AUTOTB_TVIN_in_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_data_V.dat"
`define AUTOTB_TVIN_in_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_keep_V.dat"
`define AUTOTB_TVIN_in_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_strb_V.dat"
`define AUTOTB_TVIN_in_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_user_V.dat"
`define AUTOTB_TVIN_in_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_last_V.dat"
`define AUTOTB_TVIN_in_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_id_V.dat"
`define AUTOTB_TVIN_in_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvin_in_stream_V_dest_V.dat"
...
`define AUTOTB_TVOUT_out_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_out_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_user_V.dat"
`define AUTOTB_TVOUT_out_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_last_V.dat"
`define AUTOTB_TVOUT_out_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_id_V.dat"
`define AUTOTB_TVOUT_out_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_in_stream_V_data_V = 256;
parameter LENGTH_in_stream_V_keep_V = 256;
parameter LENGTH_in_stream_V_strb_V = 256;
parameter LENGTH_in_stream_V_user_V = 256;
parameter LENGTH_in_stream_V_last_V = 256;
parameter LENGTH_in_stream_V_id_V = 256;
parameter LENGTH_in_stream_V_dest_V = 256;
parameter LENGTH_out_stream_V_data_V = 256;
parameter LENGTH_out_stream_V_keep_V = 256;
parameter LENGTH_out_stream_V_strb_V = 256;
parameter LENGTH_out_stream_V_user_V = 256;
parameter LENGTH_out_stream_V_last_V = 256;
parameter LENGTH_out_stream_V_id_V = 256;
parameter LENGTH_out_stream_V_dest_V = 256;
parameter LENGTH_sample_rate = 1;
