...
`define TV_OUT_out_stream_TDATA "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_data_V.dat"
`define EGRESS_STATUS_out_stream_TDATA "../tv/stream_size/stream_egress_status_out_stream_V_data_V.dat"
`define TV_OUT_out_stream_TKEEP "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_keep_V.dat"
`define EGRESS_STATUS_out_stream_TKEEP "../tv/stream_size/stream_egress_status_out_stream_V_keep_V.dat"
`define TV_OUT_out_stream_TSTRB "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_strb_V.dat"
`define EGRESS_STATUS_out_stream_TSTRB "../tv/stream_size/stream_egress_status_out_stream_V_strb_V.dat"
`define TV_OUT_out_stream_TUSER "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_user_V.dat"
`define EGRESS_STATUS_out_stream_TUSER "../tv/stream_size/stream_egress_status_out_stream_V_user_V.dat"
`define TV_OUT_out_stream_TLAST "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_last_V.dat"
`define EGRESS_STATUS_out_stream_TLAST "../tv/stream_size/stream_egress_status_out_stream_V_last_V.dat"
`define TV_OUT_out_stream_TID "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_id_V.dat"
`define EGRESS_STATUS_out_stream_TID "../tv/stream_size/stream_egress_status_out_stream_V_id_V.dat"
`define TV_OUT_out_stream_TDEST "../tv/rtldatafile/rtl.EQ.autotvout_out_stream_V_dest_V.dat"
...
module AESL_axi_s_out_stream (
    ...
    fifo #(256, 32) fifo_out_stream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 4) fifo_out_stream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 4) fifo_out_stream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 2) fifo_out_stream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 1) fifo_out_stream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 5) fifo_out_stream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(256, 6) fifo_out_stream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
