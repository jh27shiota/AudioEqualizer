...
set ID 88
set hasByteEnable 0
set MemName EQ_buf_re_V_RAM_AUTO_1R1W
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler EQ_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 104
set RegSliceName EQ_regslice_both
set RegSliceInstName EQ_regslice_both_U
set CoreName ap_simcore_EQ_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
