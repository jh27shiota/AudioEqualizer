...
architecture behave of EQ_CTRL_s_axi is
    ...
    constant ADDR_SAMPLE_RATE_DATA_0 : INTEGER := 16#10#;
    constant ADDR_SAMPLE_RATE_CTRL   : INTEGER := 16#14#;
